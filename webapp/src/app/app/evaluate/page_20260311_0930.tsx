        ...
        <div className="container">
            ...
            <div id="deepInfoPanel" className={`deep-info-panel ${showDeepInfo ? 'active' : ''}`} style={{ display: showDeepInfo ? 'block' : 'none' }}>
                ...
                <div className="deep-info-section">
                    ...
                    <button id="addProductBtn" className="add-shareholder-btn secondary" style={{}}>+
                        添加产品/技术</button>
                </div>
                ...
                <div className="deep-info-section">
                    ...
                    <button id="addShareholderBtn" className="add-shareholder-btn secondary">+ 添加股东</button>
                    <button id="generateMermaidBtn" className="generate-mermaid-btn">生成股权结构图</button>
                </div>

                {/* Mermaid图表容器 */}
                <div className="mermaid-container">
                    <div className="mermaid-controls">
                        <button id="zoomInBtn" title="放大图表 (Ctrl+加号)">放大</button>
                        <button id="zoomOutBtn" title="缩小图表 (Ctrl+减号)">缩小</button>
                        <button id="resetZoomBtn" title="重置缩放 (Ctrl+0)">复原</button>
                    </div>
                    <div id="mermaidChart" className="mermaid-chart">
                        {/* Mermaid图表将在这里显示 */}
                    </div>
                    <p id="mermaidPlaceholder">点击"生成股权结构图"按钮查看股权结构图</p>
                </div>
            </div>
            ...
            <div id="aiPanel" className={`ai-panel ${showAiSettings ? '' : 'hidden'}`} style={{ display: showAiSettings ? 'block' : 'none' }}>
                <div className="input-group">
                    ...
                    <div className="ai-input-group">
                        <input type="password" id="apiKey" placeholder="輸入您的算法實驗室 API Key" value="" />
                        <button id="saveApiKeyBtn">保存Key</button>
                        <button id="testApiBtn" className="api-test-btn">測試連接</button>
                    </div>
                    <div className="input-hint">
                        輸入您的算法實驗室 API Key。您可以在 <a href="https://platform.deepseek.com/api-keys" target="_blank"
                ...
                <div className="ai-options">
                    <div className="input-group">
                        ...
                        <div className="ai-models">
                            <div className={`model-option ${aiConfig.model === 'deepseek-chat' ? 'selected' : ''}`} onClick={() => setAiConfig(p => ({ ...p, model: 'deepseek-chat' }))}>算法實驗室 Chat (V3)</div>
                            <div className={`model-option ${aiConfig.model === 'deepseek-reasoning' ? 'selected' : ''}`} onClick={() => setAiConfig(p => ({ ...p, model: 'deepseek-reasoning' }))}>算法實驗室 Reasoning (R1)</div>
                        </div>
                        <div className="input-hint">
                    ...
                    <div className="ai-slider-container">
                        <label htmlFor="aiTemperature">AI分析深度: <span id="tempValue">中等深度 (0.7)</span></label>
                        <input type="range" id="aiTemperature" min="0.1" max="1" step="0.1" value="0.7" />
                    ...
                    <div className="ai-slider-container">
                        <label htmlFor="aiMaxTokens">分析详细度: <span id="tokenValue">详细分析 (2000 tokens)</span></label>
                        <input type="range" id="aiMaxTokens" min="500" max="4000" step="500" value="2000" />
                        <div className="ai-slider-labels">
                            <span>简要 (500)</span>
                            <span>详细 (2000)</span>
                            <span>深度 (4000)</span>
                    ...
                    <div className="ai-advanced-options">
                        <div className="input-group">
                            <label htmlFor="aiSystemPrompt">自定义系统指令（可选）</label>
                            <textarea id="aiSystemPrompt" rows="3" placeholder="自定义AI的分析角色和指令..."></textarea>
                            <div className="input-hint">
                                例如："你是一位资深的风险投资分析师，专注于科技行业..."
                            </div>
                        </div>
                    </div>
                </div>
